    ...
    <div class="justify-content-center">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                <div class="section-title p-1 pt-3">
                    <h2 class="text-center fw-bold line"><span>All Posts</span></h2>
                </div>
                    ...
                    <ul class="list-group list-group-flush mb-2">
                        @if (count($posts)>0)
                            ...
                            <li class="list-group-item">
                                <a style="text-decoration: none" href="read/{{ $post->id }}"><h5>{{ $post->title }}</h5></a>
                                <div>
